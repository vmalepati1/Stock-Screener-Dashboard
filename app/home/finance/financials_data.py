...
def get_financials_data(sector):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=CONNECTIONS) as executor:
        future_to_financials  = (executor.submit(load_financials, t['name'], t['ticker'], pe_industry, ps_industry, pbv_industry, vebtida_industry, \
                beta_industry, margin_industry) for t in stocks_dict[sector])
