...
def get_dcf_data(ticker_name):
    ...
    return True, FCFs, revenues_row, revenue_growth_row, calculation_values

is_successful, FCFs, revenues_row, revenue_growth_row, calculation_values = get_dcf_data('AAPL')
